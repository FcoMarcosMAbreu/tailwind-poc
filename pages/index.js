              ...
              <div class="fixed top-0 left-0 z-40 items-center hidden w-full h-full p-3 text-xl bg-gray-900 bg-opacity-50 md:text-sm lg:text-base md:w-3/4 md:bg-transparent md:p-0 md:relative md:flex" /* :class="{'flex': showMenu, 'hidden': !showMenu }" */>
                <div class="flex-col w-full h-auto h-full overflow-hidden bg-white rounded-lg select-none md:bg-transparent md:rounded-none md:relative md:flex md:flex-row md:overflow-auto">
                  <div class="flex flex-col items-center justify-center w-full h-full mt-12 text-center text-indigo-700 md:text-indigo-200 md:w-2/3 md:mt-0 md:flex-row md:items-center">
                    <Link href="#">
                      <a class="inline-block px-4 py-2 mx-2 font-medium text-left text-indigo-700 md:text-white md:px-0 lg:mx-3 md:text-center">Home</a>
                    </Link>
                    <Link href="#">
                      <a class="inline-block px-0 px-4 py-2 mx-2 font-medium text-left md:px-0 hover:text-indigo-800 md:hover:text-white lg:mx-3 md:text-center">Features</a>
                    </Link>
                    <Link href="#">
                      <a class="inline-block px-0 px-4 py-2 mx-2 font-medium text-left md:px-0 hover:text-indigo-800 md:hover:text-white lg:mx-3 md:text-center">Blog</a>
                    </Link>
                    <Link href="#">
                      <a class="inline-block px-0 px-4 py-2 mx-2 font-medium text-left md:px-0 hover:text-indigo-800 md:hover:text-white lg:mx-3 md:text-center">Contact</a>
                    </Link>
                  </div>
                  <div class="flex flex-col items-center justify-end w-full h-full pt-4 md:w-1/3 md:flex-row md:py-0">
                    <Link href="#_">
                      <a class="w-full pl-6 mr-0 text-indigo-200 hover:text-white md:pl-0 md:mr-3 lg:mr-5 md:w-auto">Sign In</a>
                    </Link>
                    <Link href="#_">
                      <a class="inline-flex items-center justify-center px-4 py-2 mr-1 text-base font-medium leading-6 text-indigo-600 whitespace-no-wrap transition duration-150 ease-in-out bg-white border border-transparent rounded-full hover:bg-white focus:outline-none focus:border-indigo-700 focus:shadow-outline-indigo active:bg-indigo-700">Sign Up</a>
                    </Link>
                  </div>
                </div>
              </div>
            ...
            <div class="w-full md:w-1/2 md:px-3">
              <div class="w-full pb-6 space-y-6 sm:max-w-md lg:max-w-lg md:space-y-4 lg:space-y-8 xl:space-y-9 sm:pr-5 lg:pr-0 md:pb-0">
                ...
                <div class="relative flex flex-col sm:flex-row sm:space-x-4">
                  <Link href="#_">
                    <a class="flex items-center w-full px-6 py-3 mb-3 text-lg text-white bg-indigo-600 rounded-md sm:mb-0 hover:bg-indigo-700 sm:w-auto">
                      Try It Free
                      <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 ml-1" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="5" y1="12" x2="19" y2="12"></line><polyline points="12 5 19 12 12 19"></polyline></svg>
                    </a>
                  </Link>
                  <Link href="#_">
                    <a class="flex items-center px-6 py-3 text-gray-500 bg-gray-100 rounded-md hover:bg-gray-200 hover:text-gray-600">
                      Learn More
                    </a>
                  </Link>
                </div>
        ...
        <div class="relative w-full px-5 py-10 mx-auto sm:py-12 md:py-16 md:px-10 max-w-7xl">
          ...
          <div class="flex grid h-full grid-cols-12 gap-10 pb-10 mt-8 sm:mt-16">
            <div class="relative flex flex-col items-start justify-end h-full col-span-12 overflow-hidden rounded-xl group md:col-span-6 xl:col-span-4">
              <Link href="#_">
                <Image class="block w-full transition duration-300 ease-in-out transform bg-center bg-cover h-96 hover:scale-110" src="images/quench-satisfying.jpg" layout='fill'/>
              </Link>
              <div class="relative z-20 w-full h-auto py-8 text-white bg-purple-500 border-t-0 border-yellow-200 px-7">
                <Link href="#_">
                  <a class="inline-block text-xs font-semibold absolute top-0 -mt-3.5 rounded-full px-4 py-2 uppercase text-purple-500 bg-white">Resources</a>
                </Link>
                <h2 class="mb-5 text-5xl font-bold"><Link href="#_"><a>Refreshing Designs</a></Link></h2>
            ...
            <div class="relative flex flex-col items-start justify-end h-full col-span-12 overflow-hidden rounded-xl group md:col-span-6 xl:col-span-4">
              <Link href="#_">
                <Image class="block w-full transition duration-300 ease-in-out transform bg-center bg-cover h-96 hover:scale-110" src="images/orange.jpg" layout='fill' />
              </Link>
              <div class="relative z-20 w-full h-auto py-8 text-white bg-blue-400 border-t-0 border-yellow-200 px-7">
                <Link href="#_">
                  <a class="inline-block text-xs font-semibold absolute top-0 -mt-3.5 rounded-full px-4 py-2 uppercase text-blue-500 bg-white">Lifestyle</a>
                </Link>
                <h2 class="mb-5 text-5xl font-bold"><Link href="#_"><a>Healthier Lifestyle</a></Link></h2>
            ...
            <div class="relative flex flex-col items-start justify-end h-full col-span-12 overflow-hidden rounded-xl group sm:col-span-12 xl:col-span-4 sm:flex-row xl:flex-col">
              <Link href="#_">
                <Image class="block w-full transition duration-300 ease-in-out transform bg-center bg-cover h-96 hover:scale-110" src="images/gbc.jpg')" layout='fill' />
              </Link>
              <div class="relative z-20 flex flex-col items-start justify-center w-full h-auto py-8 text-white bg-yellow-400 border-t-0 border-yellow-200 sm:h-full xl:h-auto px-7">
                <Link href="#_">
                  <a class="inline-block text-xs font-semibold absolute sm:mb-5 xl:mb-0 sm:relative xl:absolute top-0 -mt-3.5 rounded-full px-4 py-2 uppercase text-yellow-400 bg-white">Entertainment</a>
                </Link>
                <h2 class="mb-5 text-5xl font-bold"><Link href="#_"><a>Gaming Evolution</a></Link></h2>
            ...
            <div class="grid grid-cols-12 col-span-12 gap-7">
              <div class="flex flex-col items-start col-span-12 overflow-hidden shadow-sm rounded-xl md:col-span-6 lg:col-span-4">
                <Link href="#_">
                  <a class="block transition duration-200 ease-out transform hover:scale-110">
                    <Image class="object-cover w-full shadow-sm max-h-56" src="images/workstation.jpg" layout='fill' />
                  </a>
                </Link>
                <div class="relative flex flex-col items-start px-6 bg-white border border-t-0 border-gray-200 py-7 rounded-b-2xl">
                  ...
                  <h2 class="text-base font-bold sm:text-lg md:text-xl"><Link href="#_"><a>Best Workstations of the Year</a></Link></h2>
              ...
              <div class="flex flex-col items-start col-span-12 overflow-hidden shadow-sm rounded-xl md:col-span-6 lg:col-span-4">
                <Link href="#_">
                  <a class="block transition duration-200 ease-out transform hover:scale-110">
                    <Image class="object-cover w-full shadow-sm max-h-56" src="images/snacks.jpg" layout='fill' />
                  </a>
                </Link>
                <div class="relative flex flex-col items-start px-6 bg-white border border-t-0 border-gray-200 py-7 rounded-b-2xl">
                  ...
                  <h2 class="text-base font-bold sm:text-lg md:text-xl"><Link href="#_"><a>Eating for Productivity</a></Link></h2>
              ...
              <div class="flex flex-col items-start col-span-12 overflow-hidden shadow-sm rounded-xl md:col-span-6 lg:col-span-4">
                <Link href="#_">
                  <a class="block transition duration-200 ease-out transform hover:scale-110">
                    <Image class="object-cover w-full shadow-sm max-h-56" src="images/book-design.jpg" layout='fill' />
                  </a>
                </Link>
                <div class="relative flex flex-col items-start px-6 bg-white border border-t-0 border-gray-200 py-7 rounded-b-2xl">
                  ...
                  <h2 class="text-base font-bold sm:text-lg md:text-xl"><Link href="#_"><a>A Design Mind-set</a></Link></h2>
                ...
                <div class="block w-full h-0.5 max-w-lg mt-6 bg-purple-100 rounded-full"></div>
                  <div class="items-center justify-center w-full mt-12 mb-4 lg:flex">
                    <div class="flex flex-col items-start justify-start w-full h-auto mb-12 lg:w-1/3 lg:mb-0">
                      <div class="flex items-center justify-center">
                        <div class="w-16 h-16 mr-4 overflow-hidden bg-gray-200 rounded-full">
                          <Image src="images/photo-1527980965255-d3b416303d12.avif" class="object-cover w-full h-full" layout='fill' />
                        </div>
                    ...
                    <div class="flex flex-col items-start justify-start w-full h-auto px-0 mx-0 mb-12 border-l border-r border-transparent lg:w-1/3 lg:mb-0 lg:px-8 lg:mx-8 lg:border-gray-200">
                      <div class="flex items-center justify-center">
                        <div class="w-16 h-16 mr-4 overflow-hidden bg-gray-200 rounded-full">
                          <Image src="images/photo-1544725176-7c40e5a71c5e.avif" class="object-cover w-full h-full" layout='fill' />
                        </div>
                        <div class="flex flex-col items-start justify-center">
                      ...
                      <div class="flex flex-col items-start justify-start w-full h-auto lg:w-1/3">
                        <div class="flex items-center justify-center">
                          <div class="w-16 h-16 mr-4 overflow-hidden bg-gray-200 rounded-full">
                            <Image src="images/photo-1545167622-3a6ac756afa4.avif" class="object-cover w-full h-full" layout='fill'/>
                          </div>
                          <div class="flex flex-col items-start justify-center">
